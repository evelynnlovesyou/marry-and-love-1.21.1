...
public class LangReader {
	...
	private static Map<String, String> createDefaultMessages() {
		...
		defaults.put("marry_success_sender", "&ayou are now married to <gold>%player%</gold>!");
		defaults.put("marry_success_target", "&a<gold>%player%</gold> is now married to you!");
		defaults.put("marry_proposal_sent", "&ayou proposed to <gold>%player%</gold>.");
		...
		defaults.put("marry_sent_proposal_expired", "&cyour proposal to <gold>%player%</gold> has expired.");
		...
		defaults.put("divorce_spouse_notified", "&c<gold>%player%</gold> has divorced you.");
